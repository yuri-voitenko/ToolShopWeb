                ...
                <body>
                    ...
                    <div class="banner-top">
                        <div class="container">
                            ...
                            <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="/viewHomePage">Home</a><label>/</label>Tools<label>/</label>Electric Tools</h3>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <!--content-->
                                    ...
                                    <div class="price-head">
                                        <div class="col-md-6 price-head1">
                                            <div class="price-top1" style="width: 250px;">
                                                ...
                                                <input form="filter" type="text" name="nameTool" placeholder="name tool" value="${requestScope.filterEntity.nameTool}">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                        ...
                        <c:choose>
                                    ...
                                    <div class="price-head">
                                        <div class="col-md-6 price-head1">
                                            <div class="price-top1">
                                                <span class="price-top">$</span>
                                                <input form="filter" type="text" name="lowPrice" placeholder="min" pattern="\d*" value="${requestScope.filterEntity.lowPrice}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 price-head2">
                                            <div class="price-top1">
                                                <span class="price-top">$</span>
                                                <input form="filter" type="text" name="highPrice" placeholder="max" pattern="\d*" value="${requestScope.filterEntity.highPrice}">
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                            ...
                            <div class="col-md-9 animated wow fadeInRight" data-wow-delay=".5s">
                                <div class="mens-toolbar">
                                    <c:set var="indexStartToolOnPage" value="${(requestScope.filterEntity.numberPage*requestScope.filterEntity.numberToolsOnPage)}"
                                    />
                                    <c:set var="indexFinishToolOnPage" value="${indexStartToolOnPage+requestScope.filterEntity.numberToolsOnPage}" />
                                    ...
                                    <p>
                                        Showing ${indexStartToolOnPage+1}–${indexFinishToolOnPage} of ${requestScope.numberSuitableTools} results</p>
                                                ...
                                                <c:forEach begin="0" end="${requestScope.amountPages-1}" varStatus="loop">
                                                    <c:choose>
                                                        <c:when test="${requestScope.filterEntity.numberPage == loop.index}">
                                                            <a href="#" onclick="numberPage.value=${loop.index}; filter.submit();" class="active">${loop.index + 1}</a>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <a href="#" onclick="numberPage.value=${loop.index}; filter.submit();">${loop.index + 1}</a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </c:forEach>
                                            </div>
