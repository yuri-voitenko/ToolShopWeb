                        ...
                        <form name="loginForm" action="/loginUser" method="post" onsubmit="return validateLoginForm('loginForm')">
                            <div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
                                <div class="login-mail">
                                    <input type="text" name="email" placeholder="Email" value="${requestScope.logEntity.email}" required="">
                                    <i class="glyphicon glyphicon-envelope"></i>
                                </div>
                                <div class="login-mail">
                                    <input type="password" name="password" placeholder="Password" value="${requestScope.logEntity.password}" required="">
