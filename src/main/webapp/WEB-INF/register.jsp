                ...
                <body>
                    ...
                    <div class="login">
                        <div class="container" id="container">
                            ...
                            <form name="registerForm" action="/registerUser" method="post" enctype="multipart/form-data" onsubmit="return validateRegisterForm('registerForm')">
                                <div class="col-md-6 login-do1 animated wow fadeInLeft" data-wow-delay=".5s">
                                    <div class="login-mail">
                                        <input type="text" name="fullName" placeholder="Full name" value="${requestScope.regEntity.fullName}" required="">
                                        <img src="images/ID.png" alt="" />
                                    </div>
                                    <div class="login-mail">
                                        <input type="text" name="address" placeholder="Address" value="${requestScope.regEntity.address}" required="">
                                        <i class="glyphicon glyphicon-map-marker"></i>
                                    </div>
                                    <div class="login-mail">
                                        <input type="text" name="phoneNumber" placeholder="+X-XXX-XXX-XXXX" value="${requestScope.regEntity.phoneNumber}" required="">
                                        <i class="glyphicon glyphicon-earphone"></i>
                                    </div>
                                    <div class="login-mail">
                                        <input type="text" name="email" placeholder="Email" value="${requestScope.regEntity.email}" required="">
                                        <i class="glyphicon glyphicon-envelope"></i>
                                    </div>
                                    <div class="login-mail">
                                        <input type="password" name="password" placeholder="Password" value="${requestScope.regEntity.password}" required="">
                                        <i class="glyphicon glyphicon-lock"></i>
                                    </div>
                                    <div class="login-mail">
                                        <input type="password" name="passwordCheck" placeholder="Repeated password" value="${requestScope.regEntity.repeatedPassword}"
                                            required="">
