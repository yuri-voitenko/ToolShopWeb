...
VALUES
    ...
    ("XVF-15874", "Perforator", "Craftec", 4000, 97000, 2.2, 77.2, "pr3_1.jpg", "pr3_2.jpg"),
    ...
    ("TJL-59445", "Electric saw", "Bosch", 4000, 85000, 3.8, 35.3, "pr9_1.jpg", "pr9_2.jpg"),
    ("ZJM-64244", "Feed chopper", "VEGIS", 2500, 10000, 4.2, 44.3, "pr10_1.jpg", "pr10_2.jpg"),
    ("BKB-68153", "Sharpen machine", "Ритм", 3200, 97000, 2.1, 47.5, "pr11_1.jpg", "pr11_2.jpg"),
    ("CDI-16073", "Welding machine", "Edon", 3500, 80000, 2.5, 23.6, "pr12_1.jpg", "pr12_2.jpg"),
    ...
    ("HVQ-50558", "Electric mower", "Expert", 4000, 80000, 2.2, 37.8, "pr15_1.jpg", "pr15_2.jpg"),
    ("AEY-08705", "Electric fretsaw", "Bravo", 2600, 97000, 3.0, 25.3, "pr16_1.jpg", "pr16_2.jpg"),
    ("ABQ-85934", "Electric stapler", "Titan", 2900, 10000, 2.7, 25.2, "pr17_1.jpg", "pr17_2.jpg"),
    ("YTG-85933", "Electric airbrush", "Stern", 3500, 80000, 4.2, 36.1, "pr18_1.jpg", "pr18_2.jpg"),
    ("FAJ-56317", "Vibrating grinder", "Дніпро-М", 4000, 15000, 2.0, 48.0, "pr19_1.jpg", "pr19_2.jpg"),
    ("XSZ-12517", "Wall chaser", "Hitachi", 3200, 85000, 4.9, 25.9, "pr20_1.jpg", "pr20_2.jpg");